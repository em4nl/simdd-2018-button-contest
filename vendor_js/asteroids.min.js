...
// http://www.websiteasteroids.com/asteroids.min.js -
// I would've loaded it from there, but it doesn't support because
// the server isn't reachable via https ...
  ...
  function Asteroids() {
    ...
    if (typeof G_vmlCanvasManager != 'undefined') {
      ...
      if (!this.canvas.getContext) {
        alert(
          'So... you are using IE?  Sorry but at the moment WebsiteAsteroids only supports Firefox'
        )
      }
    } else {
      if (!this.canvas.getContext) {
      ...
      if (script.readyState == 'loaded' || script.readyState == 'complete') {
        if (typeof G_vmlCanvasManager != 'undefined')
          window.ASTEROIDSPLAYERS[
            window.ASTEROIDSPLAYERS.length
          ] = new Asteroids()
      }
    }
